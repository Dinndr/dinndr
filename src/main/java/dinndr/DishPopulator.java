...
public class DishPopulator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Dish bonelessChicken = new Dish("Boneless Chicken",
				...
				"Tandoori Grill", "$10.00", "/images/tg-tandoorplatter.jpg", "Chicken", "Rice", "Desi", "Savory",
				"Platter");
		...
		Dish goatQormaCurry = new Dish("Goat Qorma Curry",
				...
				"Tandoori Grill", "$14.00", "/images/tg-goatchops.jpg", "Goat", "Savory", "Spicy", "Desi", "Platter");
		...
		Dish chanaMasala = new Dish("Chana Masala",
				...
				"Tandoori Grill", "$7.00", "/images/tg-chana-masala.jpg", "Vegetarian", "Desi", "Beans", "Chickpeas",
				"Spicy");
		chanaMasala = dishRepo.save(chanaMasala);
		Dish chickenKathiRoll = new Dish("Chicken Kathi Roll",
				"Boneless chicken pieces marinated in tandoori sauce and grilled in tandoor.", "Tandoori Grill",
				"$6.00", "/images/tg-kebab-wrap.jpg", "Chicken", "Sandwich", "Wrap", "Desi", "Savory");
		...
		Dish rasMalai = new Dish("Ras Malai",
				...
				"Tandoori Grill", "$2.00", "/images/tg-ras-malai.jpg", "Sweet", "Dessert", "Desi", "Dairy", "Creamy");
		rasMalai = dishRepo.save(rasMalai);
		Dish blueCheesePotatoChips = new Dish("Blue Cheese Potato Chips",
				"a Cap City original, blue cheese, chives and Alfredo sauce", "Cap City", "$9.99",
				"/images/cc-chips.jpg", "Small-plate", "Vegetarian", "Cheese", "Savory", "Fried");
		...
		Dish capCityDinerMeatloaf = new Dish("Cap City Diner Meatloaf",
				...
				"Cap City", "$17.79", "/images/cc-meatloaf.jpg", "Beef", "Savory", "Platter", "Savory", "Meat");
		...
		Dish pecanCrustedPorkChops = new Dish("Pecan Crusted Pork Chops",
				...
				"Cap City", "$21.99", "/images/cc-porkchops.jpg", "Pork", "Nutty", "Savory", "Platter", "Meat");
		pecanCrustedPorkChops = dishRepo.save(pecanCrustedPorkChops);
		Dish romanoCrustedChicken = new Dish("Romano Crusted Chicken",
				"crispy fried chicken, garlic buttered noodles, roasted tomato cream sauce", "Cap City", "$17.99",
				"/images/cc-chicken.jpg", "Dinner", "Chicken", "Cheese", "Tomato", "Creamy");
		...
		Dish seriouslyBigChocolateCake = new Dish("Seriously Big Chocolate Cake", "our famous three-layer cake",
				"Cap City", "$7.99", "/images/cc-chocolatecake.jpg", "Dessert", "Sweet", "Chocolate", "Cake", "Giant");
		...
		Dish halfSlabSmokedStLouisCutSpareRibs = new Dish("Half Slab Smoked St Louis Cut Spare Ribs",
				...
				"Ray Ray's", "$11.00", "/images/ray-half-slab-smoked-st-louis-cut-spare-ribs.jpg", "Dinner", "Savory",
				"American", "BBQ", "Pork");
		...
		Dish jerkChicken = new Dish("Jerk Chicken",
				...
				"Ray Ray's", "$7.00", "/images/ray-jerk-chicken.jpg", "Dinner", "Savory", "Sandwich", "Chicken", "BBQ");
		...
		Dish beefBrisket = new Dish("Beef Brisket",
				...
				"Ray Ray's", "$8.00", "/images/ray-beef-brisket.jpg", "Dinner", "Savory", "Sandwich", "Beef", "BBQ");
		beefBrisket = dishRepo.save(beefBrisket);
		Dish scratchMacNCheese = new Dish("Scratch Mac-N-Cheese",
				"Noodles cooked to perfection and surounded by delicious cheesey goodness.", "Ray Ray's", "$4.00",
				"/images/ray-scratch-mac-n-cheese.jpg", "Small-plate", "Savory", "Cheese", "Vegetarian", "Creamy");
		scratchMacNCheese = dishRepo.save(scratchMacNCheese);
		Dish bananaPudding = new Dish("Banana Puddin'",
				"This classic dessert is served exclusivley at Ray Ray's Clintonville location.", "Ray Ray's", "$3.00",
				"/images/ray-banana-pudding.jpg", "Dessert", "Sweet", "Chocolate", "Rich", "Vegetarian");
		...
		Dish spicyYumaPizza = new Dish("Spicy Yuma Pizza",
				...
				"Harvest Pizzeria", "$15.75", "images/harvest-spicyyuma.jpg", "Pizza", "Spicy", "Cheese", "Meat",
				"Savory");
		spicyYumaPizza = dishRepo.save(spicyYumaPizza);
		Dish pimentoCheese = new Dish("Pimento Cheese", "with sour dough , bread and butter pickles",
				"Harvest Pizzeria", "$7.00", "images/harvest-pimento.jpg", "Cheese", "Dip", "Savory", "Creamy",
				"Small-plate");
		pimentoCheese = dishRepo.save(pimentoCheese);
		Dish margheritaPizza = new Dish("Margherita Pizza", "Fresh Mozarella, Basil", "Harvest Pizzeria", "$12.75",
				"images/margarita.jpg", "Pizza", "Vegetarian", "Cheese", "Italian", "Meat");
		margheritaPizza = dishRepo.save(margheritaPizza);
		Dish meanGreenSalad = new Dish("Mean Green Salad",
				"Spinach, arugula, black beluga lentils, avocado green goddess dressing", "Harvest Pizzeria", "$6.00",
				"images/meangreen.jpg", "Salad", "Vegetarian", "Healthy", "Green", "Fresh");
		...
		Dish buckeyeBrownie = new Dish("Buckeye Brownie", "Chocolate, Krema Peanut Butter, Vanilla Bean Ice Cream",
				"Harvest Pizzeria", "$7.00", "images/buckeye.jpg", "Dessert", "Sweet", "Cake", "Chocolate", "Platter");
		...
		Dish germanRoastPorkLoin = new Dish("German Roast Pork Loin",
				...
				"Mozart's", "$14.95", "images/mozarts-pork-loin-na.jpg", "Platter", "Pork", "Meat", "Savory", "Creamy");
		germanRoastPorkLoin = dishRepo.save(germanRoastPorkLoin);
		Dish hamGorgonzolaSpatzle = new Dish("Ham & Gorgonzola Spatzle",
				"House made spatzle and smokey Black Forest ham simmered in a creamy gorgonzola sauce.", "Mozart's",
				"$12.95", "images/mozarts-spatzle.jpg", "Platter", "Spatzle", "Pork", "Cheese", "Meat");
		...
		Dish beefStroganoff = new Dish("Beef Stroganoff",
				...
				"Mozart's", "$15.95", "images/mozarts-beef-stroganoff.jpg", "Platter", "Meat", "Beef", "Gravy",
				"Spatzle");
		...
		Dish wienerSchnitzel = new Dish("Wiener Schnitzel",
				...
				"Mozart's", "$15.95", "images/mozarts-wiener-schnitzel.jpg", "Platter", "Meat", "Veal", "Rich",
				"Spatzle");
		...
		Dish chocolateGanacheTorte = new Dish("Chocolate Ganache Torte",
				...
				"Mozart's", "$12.00", "images/mozarts-torte.jpg", "Dessert", "Chocolate", "Creamy", "Tort", "Rich");
		chocolateGanacheTorte = dishRepo.save(chocolateGanacheTorte);
		Dish quinoaTabouliSalad = new Dish("Quinoa Tabouli Salad",
				"Quinioa, kale, cherry tomatoes, parsley and red onion in a lemon vinagrette with a tahini dressing drizzle",
		...
		Dish moleBowl = new Dish("Mole Bowl",
				...
				"Acre", "$9.85", "images/acre-mole-bowl.jpg", "Bowl", "Vegetarian", "Spicy", "Platter", "Gravy");
		...
		Dish bbqRanchWrap = new Dish("BBQ Ranch Wrap",
				...
				"Acre", "$9.45", "images/acre-ranch-wrap.jpg", "Wrap", "BBQ", "Spicy", "Healthy", "Savory");
		...
		Dish srirachaChickenSaladSandwich = new Dish("Sriracha Chicken Salad Sandwich",
				...
				"images/acre-sriracha-chicken-salad.jpg", "Sandwich", "Chicken", "Spicy", "Small-plate", "Fresh");
		...
		Dish bbqPorkSandwich = new Dish("BBQ Pork Sandwich",
				...
				"images/acre-bbq-pork-sandwich.jpg", "Sandwich", "Pork", "Small-plate", "Healthy", "BBQ");
		...
		Dish grilledSirloinSteakBurroGrande = new Dish("Grilled Sirloin Steak Burro Grande",
				...
				"El Vaquero", "$11.85", "/images/ev-burrito-grande.jpg", "Platter", "Spicy", "Meat", "Wrap",
				"Small-plate");
		...
		Dish enchiladasVegetales = new Dish("Enchiladas Vegetales",
				...
				"El Vaquero", "$11.75", "/images/ev-enchilades-vegetales.jpg", "Vegetarian", "Platter", "BBQd", "Spicy",
				"Cheese");
		...
		Dish polloMargarita = new Dish("Pollo Margarita",
				...
				"El Vaquero", "$12.99", "/images/ev-pollo-margarita.jpg", "Platter", "Spicy", "Chicken", "BBQ", "Meat");
		...
		Dish elManjarVaquero = new Dish("El Manjar Vaquero",
				...
				"El Vaquero", "$15.75", "/images/ev-el-manjar-vaquero.jpg", "Platter", "Chicken", "Rice", "Spicy",
				"Meat");
		...
		Dish tacosDePescado = new Dish("Tacos de Pescado", "Fish tacos, broccoli cole slaw, chipotle sauce and lime",
				"El Vaquero", "$9.99", "/images/ev-tacos-de-pescado.jpg", "Wrap", "Lunch", "Broccoli", "Spicy", "Fish");
